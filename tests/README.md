...
|---|---|---|---|---|
| E2E | `tests/e2e/` | Playwright journeys mapped to `docs/biz/uses.md` demos and README eval rows 1–18. | `cd tests/e2e && npm ci && npm run test` | `tests/e2e/.github/workflows/e2e-playwright.yml` |
