# Recording and transcription disclosure scripts

These scripts are placeholders for legal review and should align with `apps/web/i18n/messages/{lang}.json` keys `voice.recordingDisclosure` and `voice.transcriptionConsent`.

- **da**: Samtalen kan blive optaget og transskriberet for at behandle din sag. Tryk 1 for at acceptere eller 0 for en medarbejder uden optagelse hvor muligt.
- **sv**: Samtalet kan spelas in och transkriberas för att behandla ditt ärende. Tryck 1 för att godkänna eller 0 för en handläggare.
...
- **ar**: قد يتم تسجيل هذه المكالمة وتفريغها لمعالجة طلبك. اضغط 1 للموافقة أو 0 للتحدث إلى موظف.
- **uk**: Цей дзвінок може записуватися і транскрибуватися для розгляду вашої справи. Натисніть 1 для згоди або 0 для оператора.
- **fi**: Puhelu voidaan tallentaa ja litteroida asiasi käsittelyä varten. Paina 1 hyväksyäksesi tai 0 saadaksesi ihmisen apua.
