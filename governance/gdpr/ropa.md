...
| 3 | Eligibility pre-assessment (AI-assisted) | Applicants | Slot-filled form fields, derived eligibility flag | Caseworker (advisory only) | None | 30d (Cosmos draft), then mirrored to OneLake Bronze/Silver/Gold | Art. 6(1)(e) + AI Act Art. 26 |
