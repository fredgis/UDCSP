// name: no-external-id | owner agent: A2 | purpose: country Microsoft Entra External ID (CIAM) tenant scaffold
...
param displayName string = 'UDCSP NO External ID'
...
resource externalIdTenant 'Microsoft.AzureActiveDirectory/ciamDirectories@2023-05-17-preview' = {
  name: 'udcspno${env}.onmicrosoft.com'
  location: location
  sku: {
    name: 'Base'
    tier: 'A0'
